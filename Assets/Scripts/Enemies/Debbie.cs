...
public class Debbie : Enemy
{
    ...
    protected void FlyingShoot()
    {
        ...
        shot = Instantiate(projectilePrefab);
        shot_rigid = shot.GetComponent<Rigidbody2D>();
        shot_rigid.AddForce(new Vector2(-200, -500));
        shot.transform.position = new Vector3(transform.position.x - .8f, transform.position.y - 1f);
        Destroy(shot, 2);
    ...
    protected void SpawnMinions()
    {
        ...
        minions.Add(minion);
        minion.transform.position = transform.position + new Vector3(-10, -1.35f);
        minion = Instantiate(minionPrefab);
        minions.Add(minion);
        minion.transform.position = transform.position + new Vector3(-5, -1.35f);
        minion = Instantiate(minionPrefab);
        minions.Add(minion);
        minion.transform.position = transform.position + new Vector3(5, -1.35f);
        minion = Instantiate(minionPrefab);
