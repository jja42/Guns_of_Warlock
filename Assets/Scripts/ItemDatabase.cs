...
public class ItemDatabase : MonoBehaviour
{
    ...
    void BuildDatabase()
    {
        items = new List<Item>() {
            ...
            new Item(2,"Invisibility Potion","Don't do nothing pervy with it.",200,1,0,1),
            new Item(3, "Small Health Potion","Restores one Heart. Does ya good.",20,1,0,1),
            ...
            new Item(9, "Ring of Game Mechanic Progression","This ain't exactly optional",100,1,1,1)
        };
    }
}